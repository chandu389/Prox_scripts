/*
* Name: getSchedulerStatusByID.js
...
*
*	//INPUTS:
*   	id: [Generic Input Text] Mandatory
*	//OUTPUTS:
...
function getSchedulerStatusByID(URL){
...
output.xmlResponse = getSchedulerStatusByID("http://connectivity.cumulosslab.local/api/getSchedulerStatusByID/"+input.id);
