/*
* Name: parseLinuxOSVersionResponse.js
...
*
* Description:
*	This custom task parse getOSVersion API and creates entry in SiLinuxOS PSC table.
*
*	//INPUTS:
...
for(var i=0;i<list.length;i++){
    ...
    if (serviceItemData.length() > 0){
	   ...
	   SIData.push("OSVersion="+os);
       //SIData    = SIData.replace("/(.*?)=.*?;(.*)/","$1="+generateUUID()+";$2");
    }else{
        action = "Create";
        SIData = ["Name="+UUIDStr,"OSVersion="+os];
    }
